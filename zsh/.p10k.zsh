# Generated by Powerlevel10k configuration wizard on 2024-11-03 at 16:45 PST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%250F'  # grey foreground
      local      clean='%250F'  # grey foreground
      local   modified='%250F'  # grey foreground
      local  untracked='%250F'  # grey foreground
      local conflicted='%250F'  # grey foreground
    fi
